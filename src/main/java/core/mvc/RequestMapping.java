...
import next.controller.QuestionCreateController;
...
public class RequestMapping {
    ...
    void initMapping() {
        ...
        mappings.put("/question/create", new QuestionCreateController());
        mappings.put("/question/form", new QuestionFormController());
        mappings.put("/question/show", new QuestionDetailController());
        mappings.put("/question/delete", new QuestionDeleteController());
